    ...
    @else
        <header x-data="{ isActive:false }" class="text-gray-600 body-font shadow-md fixed top-0 left-0 right-0 bg-gray-400">
            <div class="w-full flex flex-row justify-between p-5 items-center">
                ...
                <div class="hidden md:inline-block">
                    <div class="text-white">
                        <a href="{{ route('user.login') }}" class="p-5 hover:text-gray-600 hover:border-b-4 border-white-500 target:border-b-4 border-white-500">ログイン</a>
                        <a href="{{ route('user.register') }}" class="p-5 hover:text-gray-600 hover:border-b-4 border-white-500">会員登録</a>
                    </div>
                </div>
                <div class="md:hidden">
                    <button @click="isActive =! isActive" class="hover:bg-gray-500">
            ...
            <div id="content" x-cloak x-show="isActive" class="flex flex-col w-full text-center text-black body-font shadow-md fixed bg-gray-300 border border-gray-500">
                <div class="">
                    <a href="{{ route('user.login') }}" class="block p-4 hover:bg-gray-400">ログイン</a>
                    <a href="{{ route('user.register') }}" class="block p-4 hover:bg-gray-400">会員登録</a>
                </div>
            </div>
        </header>
    @endif
