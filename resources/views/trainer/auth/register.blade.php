        ...
        <section class="flex flex-col md:flex-row h-screen items-center">
            ...
            <div class="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12 flex items-center justify-center">
                <div class="w-full h-100">
                    ...
                    <form class="mt-16" action="{{ route('trainer.register') }}" method="POST">
                    @csrf
                        <div>
                    ...
                    <a href="{{ route('trainer.login') }}" class="block text-center text-blue-500 hover:text-blue-700 font-semibold">ログインへ</a>
                </div>
            </div>
        </section>
    </main>
