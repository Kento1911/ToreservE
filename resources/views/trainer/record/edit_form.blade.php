        ...
        <main class="bg-gray-200 lg:container mx-auto">
            <div class="bg-gray-200">
                    <section class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-4 pt-28 md:pt-32 pb-8">
                        <form method="POST" action="{{ route('trainer.record.edit',['schedule' => $schedule]) }}">
                            @csrf
                            <div class="p-4 bg-white rounded-lg shadow-lg">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <div class="w-full mt-5">
                                        ...
                                        <textarea name="menu" id="" cols="30" rows="3" class="w-full rounded-lg border border-teal-500 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent" required>{{ $record->menu }}</textarea>
                                    </div>
                                    <div class="w-full mt-3">
                                        <label for=""  class="ml-2 block">アドバイス</label>
                                        <textarea name="feedback" id="" cols="30" rows="10" class="w-full rounded-lg border border-teal-500 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent" required>{{ $record->feedback }}</textarea>
                                    </div>
                                    @endforeach
                                </div>
                            </div>
