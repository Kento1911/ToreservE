    ...
    <main class="bg-gray-200">
        <section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 pt-32 pb-16">
            <div class="p-4">
                ...
                <form method="POST" action="{{ route('trainer.record.research') }}">
                    @csrf
                        ...
                        <div class="max-w-full bg-white flex flex-col rounded overflow-hidden shadow-lg mt-5">
                            ...
                            <div class="mt-4 bg-gray-100 flex flex-row justify-around md:justify-end">
                                <div class="md:border-l-2 mx-6 md:border-dotted flex flex-row py-4">
                                    <a href="{{ route('trainer.record.detail',['schedule' => $schedule]) }}" class="w-32 h-11 flex border border-gray-700 text-gray-700 hover:bg-gray-50 mx-2 justify-center place-items-center rounded-lg"><div class="">詳細</div></a>
                                </div>
                            </div>
                        </div>
                    @endforeach
